...
class PublicRoomChatMessageAdmin(admin.ModelAdmin):
    list_filter= ('room', 'user', 'registration')
    list_display= ('room', 'user', 'registration', 'content')
    searching_fields = ('room__title', 'user__username', 'content')
    readonly_fields= ('id', 'user', 'room','registration')
